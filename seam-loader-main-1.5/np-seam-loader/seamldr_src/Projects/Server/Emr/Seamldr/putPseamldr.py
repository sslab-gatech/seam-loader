...
map_txt = f_map.read()
f_map.close()
regex_result = re.search(r"([0-9a-f]+):([0-9a-f]+)\s+_PSeamldrConstAsm", map_txt)
PseamldrConst = Offset(int(regex_result.group(1), 16), int(regex_result.group(2),16))
regex_result = re.search(r"([0-9a-f]+):([0-9a-f]+)\s+_PSeamldrSizeAsm", map_txt)
PseamldrSize = Offset(int(regex_result.group(1), 16), int(regex_result.group(2),16))
regex_result = re.search(r"([0-9a-f]+):([0-9a-f]+)\s+_PSeamldrAsm", map_txt)
